...
Here's what I've been learning: almost every app starts as a web app anyway. Whether you're using a platform like [Median.co](https://median.co) to wrap your web content into a native iOS and Android shell, or you're eventually going full native — you need the web layer first. The logic, the interface, the experience. That has to exist before anything else does.
